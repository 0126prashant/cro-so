...
if not website_documents:
    ...
    model = ChatOpenAI(api_key=key, model="gpt-4-vision-preview", temperature=2, max_tokens=200)
...
def process_image(image_url, creator_id):
    ...
    model2 = ChatOpenAI(api_key=key, model="gpt-4-vision-preview", temperature=4, max_tokens=500)
